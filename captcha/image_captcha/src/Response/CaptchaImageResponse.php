...
class CaptchaImageResponse extends Response {
  ...
  function get_solution_name($file_path_name) {
    $lines = file($file_path_name, FILE_IGNORE_NEW_LINES);
  ...
  public function sendContent() {
    ...
    if ($file_format == IMAGE_CAPTCHA_FILE_FORMAT_JPG) {
    	$image_name = @$this->get_solution_name($file_path_for_captcha);
    	imagejpeg($this->image, "TEMP".$image_name.".jpeg");
